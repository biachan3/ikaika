                        ...
                        <div class="card-body">
                            <form role="form" class="text-start" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <input id="name" class="form-control block mt-1 w-full" type="text" name="name" required
                                    autofocus/>
                                </div>
                                ...
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <input id="year" class="form-control block mt-1 w-full" type="text" name="year" required
                                    />
                                </div>

                                <div class="input-group input-group-outline my-3">
                                    <label class="form-label" for="work">Work</label>
                                    <input id="work" class="form-control block mt-1 w-full" type="text" name="work" required
                                    />
                                </div>

                                <div class="input-group input-group-outline my-3">
                                    <label class="form-label" for="faculty">Faculty</label>
                                    <input id="faculty" class="form-control block mt-1 w-full" type="text" name="faculty" required
                                    />
                                </div>
                                ...
                                {{-- <button class="w-200 mt-3 ml-3"> --}}
                                    <a href="{{ route('login') }}" class=" ">
                                        <p class="mt-4 text-sm text-center">Already registered?</p>
                                    </a>
                                {{-- </button> --}}
