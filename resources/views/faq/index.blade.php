            ...
            <div class="event-schedule-tabs mt-5">
                <div class="event-schedule-item">
                    <div class="schedule-item-info active">
                        ...
                        <h4>Bagaimana cara mendaftarkan diri di Acara Reuni Akbar IKA UBAYA?</h4>
                        <div class="schedule-info-content"
                            ...
                            <p>Setelah membayar, Anda akan mendapatkan QR Code sebagai undangan yang akan Anda tunjukkan
                                pada panitia pada saat ingin masuk ke tempat acara.</p>
                        </div>
                    </div>
                </div>
                <div class="event-schedule-item">
                ...
                <div class="event-schedule-item">
                    <div class="schedule-item-info active">
                        {{-- <div class="date">9:00 - 11:00</div> --}}
                        <h4>Dimana acara Reuni Akbar IKA UBAYA dalam rangka Dies Natalis 55 tahun IKA UBAYA diadakan?</h4>
                        <div class="schedule-info-content"
                            style="display: none; height: auto; padding: 0px 0px 0px; margin: 15px 0px 0px; width: 445px; opacity: 1;">
                            <p>Acara Reuni Akbar IKA UBAYA dalam rangka Dies Natalis 55 Tahun IKA UBAYA akan diadakan di
                                lapangan depan perpustakaan UBAYA
                                Tenggilis.</p>
                        </div>
                    </div>
                </div>
                <div class="event-schedule-item">
                    <div class="schedule-item-info active">
                        {{-- <div class="date">9:00 - 11:00</div> --}}
                        <h4>Kapan acara Reuni Akbar IKA UBAYA diadakan?</h4>
                        <div class="schedule-info-content"
                            style="display: none; height: auto; padding: 0px 0px 0px; margin: 15px 0px 0px; width: 445px; opacity: 1;">
                            <p>Acara Reuni Akbar IKA UBAYA akan diadakan pada hari Sabtu, 3 Juni 2023.</p>
                        </div>
                    </div>
                </div>
                <div class="event-schedule-item">
                    <div class="schedule-item-info active">
                        {{-- <div class="date">9:00 - 11:00</div> --}}
                        <h4>Kapan Registrasi untuk acara Reuni Akbar IKA UBAYA ditutup?</h4>
                        <div class="schedule-info-content"
                            style="display: none; height: auto; padding: 0px 0px 0px; margin: 15px 0px 0px; width: 445px; opacity: 1;">
                ...
                <div class="event-schedule-item">
                    <div class="schedule-item-info active">
                        {{-- <div class="date">9:00 - 11:00</div> --}}
                        <h4>Siapa saja yang dapat mengikuti acara Reuni Akbar IKA UBAYA?</h4>
                        <div class="schedule-info-content"
                            style="display: none; height: auto; padding: 0px 0px 0px; margin: 15px 0px 0px; width: 445px; opacity: 1;">
                            <p>Seluruh Alumni UBAYA, mulai angkatan pertama hingga terakhir.</p>
                        </div>
                    </div>
                </div>
                <div class="event-schedule-item">
                ...
                <div class="event-schedule-item">
                    <div class="schedule-item-info active">
                        {{-- <div class="date">9:00 - 11:00</div> --}}
                        <h4>Bagaimana jika terlambat pada saat acara Reuni Akbar IKA UBAYA?</h4>
                        <div class="schedule-info-content"
                            style="display: none; height: auto; padding: 0px 0px 0px; margin: 15px 0px 0px; width: 445px; opacity: 1;">
                            <p>Peserta yang terlambat akan tetap diizinkan untuk mengikuti acara, tetapi dengan sisa waktu
                                yang tersisa.</p>
                        </div>
                    </div>
                </div>
                <div class="event-schedule-item">
                    <div class="schedule-item-info active">
                        {{-- <div class="date">9:00 - 11:00</div> --}}
                        <h4>Bagaimana jika berhalangan hadir pada saat acara Reuni Akbar IKA UBAYA?</h4>
                        <div class="schedule-info-content"
                            style="display: none; height: auto; padding: 0px 0px 0px; margin: 15px 0px 0px; width: 445px; opacity: 1;">
                ...
                <div class="event-schedule-item">
                    <div class="schedule-item-info active">
                        {{-- <div class="date">9:00 - 11:00</div> --}}
                        <h4>Berapa lama acara Reuni Akbar IKA UBAYA berlangsung?</h4>
                        <div class="schedule-info-content"
                            style="display: none; height: auto; padding: 0px 0px 0px; margin: 15px 0px 0px; width: 445px; opacity: 1;">
                ...
                <div class="event-schedule-item">
                    <div class="schedule-item-info active">
                        {{-- <div class="date">9:00 - 11:00</div> --}}
                        <h4>Apa Tema yang diangkat untuk acara Reuni Akbar IKA UBAYA dalam rangka Dies Natalis 55 Tahun IKA
                            UBAYA?</h4>
                        <div class="schedule-info-content"
                            style="display: none; height: auto; padding: 0px 0px 0px; margin: 15px 0px 0px; width: 445px; opacity: 1;">
                            <p>Tema yang akan digunakan dalam acara Reuni Akbar IKA UBAYA dalam rangka Dies Natalis 55 Tahun
                                IKA UBAYA adalah Stronger Together.</p>
                        </div>
                    </div>
                </div>
                <div class="event-schedule-item">
                    <div class="schedule-item-info active">
                        ...
                        <div class="schedule-info-content"
                            ...
                            <a href="https://www.instagram.com/ikaubaya/">Instagram IKA UBAYA</a><br>
                            <a href="https://www.facebook.com/ika.ubaya.9">Facebook IKA UBAYA</a>
                        </div>
                    </div>
                </div>
                {{-- <div class="event-schedule-item">
