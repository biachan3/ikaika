...
<head>
 ...
 ================================================== -->
    ...
    <link rel="apple-touch-icon" sizes="72x72"
        href="{{ asset('aoidehtml/aoide_template') }}/apple-touch-icon-72x72.png" />
    <link rel="apple-touch-icon" sizes="114x114"
        href="{{ asset('aoidehtml/aoide_template') }}/apple-touch-icon-114x114.png" />
                    ...
                    <div class="section" id="boxscroll-in-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="speaker-image">
                                            <h6>Anna Kulis</h6>
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/t1.jpg"
                                                alt="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mt-5">
                                        <div class="speaker-image">
                                            <h6>Marco Furius</h6>
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/t2.jpg"
                                                alt="" />
                                        </div>
                                    </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="speaker-image">
                                            <h6>Ivan Kulis</h6>
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/t3.jpg"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="col-md-9 mt-4 mt-md-0">
                                    ...
                                    <div class="col-md-3 mt-5">
                                        <div class="speaker-image">
                                            <h6>Marco Furius</h6>
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/t4.jpg"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="col-md-9 mt-4 mt-md-5">
                                    ...
                                    <div class="col-md-3 mt-5">
                                        <div class="speaker-image">
                                            <h6>Nia Johnson</h6>
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/t5.jpg"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="col-md-9 mt-4 mt-md-5">
                        ...
                        <div class="section padding-top padding-bottom-big background-dark footer">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <img src="{{ asset('aoidehtml/aoide_template') }}/img/logo.png"
                                            alt="" />
                                        <h6 class="mt-5 mb-3">
                                            Get in touch:
                                        </h6>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-6 col-md-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/1.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/1.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4 mt-sm-0">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/2.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/2.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4 mt-md-0">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/3.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/3.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/4.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/4.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/5.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/5.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/6.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/6.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/7.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/7.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/8.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/8.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/9.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/9.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/10.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/10.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/11.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/11.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/12.jpg"
                                            data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/12.jpg"
                                                    alt="" />
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 mt-4 mt-lg-0">
                                        <div class="sponsors">
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white1.png"
                                                alt="" />
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white2.png"
                                                alt="" />
                                    ...
                                    <div class="col-lg-9 mt-4 mt-lg-5">
                                        <div class="sponsors">
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white5.png"
                                                alt="" />
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white6.png"
                                                alt="" />
                                            <img class="mt-3 mt-md-0"
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mt-4 mt-md-0">
                                        <div class="blog-wrap pb-4">
                                            <a href="#"><img
                                                    src="{{ asset('aoidehtml/aoide_template') }}/img/blog/3.jpg"
                                                    alt="" /></a>
                                            <p class="px-4 pt-4 mb-1">
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div class="blog-wrap pb-4">
                                            <a href="#"><img
                                                    src="{{ asset('aoidehtml/aoide_template') }}/img/blog/6.jpg"
                                                    alt="" /></a>
                                            <p class="px-4 pt-4 mb-1">
                                                <small>by Frank Furius</small>
                                            </p>
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div class="blog-wrap pb-4">
                                            <a href="#"><img
                                                    src="{{ asset('aoidehtml/aoide_template') }}/img/blog/9.jpg"
                                                    alt="" /></a>
                                            <p class="px-4 pt-4 mb-1">
                                                <small>by Sandra Furius</small>
                                            </p>
