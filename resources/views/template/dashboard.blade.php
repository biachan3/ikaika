...
<body class="aoide">
   ...
   ================================================== -->
        ...
        <a href="/">
            <div class="logo">
                <div class="row">
                        <img src="{{ asset('aoidehtml/aoide_template') }}/img/Ubaya.png" width="400px" alt="" />
                </div>
        ...
        <a href="/">
            <div class="logo2">
                    <img src="{{ asset('aoidehtml/aoide_template') }}/img/55Ubaya.png" alt="" />
            </div>
        </a>
        <a href="/">
            <div class="logo3">
                    <div class="col-md-4">
                        <img src="{{ asset('aoidehtml/aoide_template') }}/img/IKA.jpeg" width="400px" alt="" />
                    </div>
            </div>
        </a>
        ...
        <div class="content">
            <nav class="menu">
                ...
                <a href="#" class="menu__item">schedule
                </a>
                <a href="#" class="menu__item">gallery

                    <div class="empty-space">-</div>
                    IKA
                </a>
                <a href="#" class="menu__item">other
                    <div class="empty-space">-</div>
                    information
                </a>
   ...
   ================================================== -->
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-6 col-md-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/1.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/1.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4 mt-sm-0">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/2.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/2.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4 mt-md-0">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/3.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/3.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/4.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/4.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/5.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/5.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/6.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/6.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/7.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/7.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/8.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/8.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/9.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/9.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/10.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/10.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/11.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/11.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4 mt-4">
                                        <a href="{{ asset('aoidehtml/aoide_template') }}/img/gallery/12.jpg" data-fancybox="gallery">
                                            <div class="img-wrap gallery">
                                                <img src="{{ asset('aoidehtml/aoide_template') }}/img/gallery/12.jpg" alt="" />
                                            </div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 mt-4 mt-lg-0">
                                        <div class="sponsors">
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white1.png" alt="" />
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white2.png" alt="" />
                                            <img class="mt-3 mt-md-0" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white3.png" alt="" />
                                            <img class="mt-3 mt-md-0" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white4.png" alt="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-9 mt-4 mt-lg-5">
                                        <div class="sponsors">
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white5.png" alt="" />
                                            <img src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white6.png" alt="" />
                                            <img class="mt-3 mt-md-0" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white7.png" alt="" />
                                            <img class="mt-3 mt-md-0" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white8.png" alt="" />
                                            <img class="mt-3" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white9.png" alt="" />
                                            <img class="mt-3" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white10.png" alt="" />
                                            <img class="mt-3" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white11.png" alt="" />
                                            <img class="mt-3" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white1.png" alt="" />
                                            <img class="mt-3" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white2.png" alt="" />
                                            <img class="mt-3" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white3.png" alt="" />
                                            <img class="mt-3" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white4.png" alt="" />
                                            <img class="mt-3" src="{{ asset('aoidehtml/aoide_template') }}/img/logos/white6.png" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="blog-wrap pb-4">
                                            <a href="#"><img src="{{ asset('aoidehtml/aoide_template') }}/img/blog/1.jpg" alt="" class="img-fluid" /></a>
                                            <p class="px-4 pt-4 mb-1">
                                                <small>by Alex Andrews</small>
                                            </p>
                                            <a href="#">
                                                <h6 class="px-4 mb-3">
                                    ...
                                    <div class="col-md-4 mt-4 mt-md-0">
                                        <div class="blog-wrap pb-4">
                                            <a href="#"><img src="{{ asset('aoidehtml/aoide_template') }}/img/blog/2.jpg" alt="" /></a>
                                            <p class="px-4 pt-4 mb-1">
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div class="blog-wrap pb-4">
                                            <a href="#"><img src="{{ asset('aoidehtml/aoide_template') }}/img/blog/4.jpg" alt="" /></a>
                                            <p class="px-4 pt-4 mb-1">
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div class="blog-wrap pb-4">
                                            <a href="#"><img src="{{ asset('aoidehtml/aoide_template') }}/img/blog/5.jpg" alt="" /></a>
                                            <p class="px-4 pt-4 mb-1">
                                                <small>by Anna Kulis</small>
                                            </p>
                                            <a href="#">
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div class="blog-wrap pb-4">
                                            <a href="#"><img src="{{ asset('aoidehtml/aoide_template') }}/img/blog/7.jpg" alt="" /></a>
                                            <p class="px-4 pt-4 mb-1">
                                                <small>by Alex Andrews</small>
                                            </p>
                                            <a href="#">
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div class="blog-wrap pb-4">
                                            <a href="#"><img src="{{ asset('aoidehtml/aoide_template') }}/img/blog/8.jpg" alt="" /></a>
                                            <p class="px-4 pt-4 mb-1">
                                                <small>by Anna Kulis</small>
                                            </p>
                                            <a href="#">
                                    ...
                                    <div class="col-lg-9 mt-4 mt-lg-0">
                                        <form name="ajax-form" id="ajax-form" action="mail-it.php" method="post">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label for="name">
                                                        <span class="error" id="err-name">please enter
                                                            name</span>
                                                    </label>
                                                ...
                                                <div class="col-lg-6 mt-4 mt-lg-0">
                                                    <label for="email">
                                                        <span class="error" id="err-email">please enter
                                                            e-mail</span>
                                                        <span class="error" id="err-emailvld">e-mail is not a
                                                            valid
                                                            format</span>
                                                    </label>
                                                ...
                                                <div class="col-lg-12 mt-4">
                                                    <div id="button-con">
                                                        <button class="send_message" id="send" data-lang="en">
                                                            <span>submit</span>
                                                        </button>
                                                    </div>
                                                </div>
        ...
        <div class="social-fixed">
            ...
            <a href="https://linktr.ee/creatoland?utm_source=linktree_profile_share&ltsid=fcd13022-9fcc-4b3c-ac6c-a3271e815408">Contact Person</a>

            <a href="https://www.facebook.com/profile.php?id=100010043347501">Fanspage</a>
        </div>
    </main>
