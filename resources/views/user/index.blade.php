@extends('user.template.dashboard')
@section('content')
<section class="s-conference-slider">
    <div class="conference-slider">
        ...
        <div class="conference-slide"
            style="background-image: url({{ asset('Ginger') }}/assets/img/slide4-home-2.jpg);">
            <img class="conference-slide-tringle" src="{{ asset('Ginger') }}/assets/img/effect-tringle-slider.svg"
                alt="img">
            <img class="conference-slide-effect" src="{{ asset('Ginger') }}/assets/img/effect-slider-left.svg"
                alt="img">
        ...
        <div class="conference-slide"
            style="background-image: url({{ asset('Ginger') }}/assets/img/slide3-home-2.jpg);">
            <img class="conference-slide-tringle" src="{{ asset('Ginger') }}/assets/img/effect-tringle-slider.svg"
                alt="img">
            <img class="conference-slide-effect" src="{{ asset('Ginger') }}/assets/img/effect-slider-left.svg"
                alt="img">
        ...
        <div class="container">
            <div class="conference-counter-wrap">
                <img class="conference-counter-effect-1"
                    src="{{ asset('Ginger') }}/assets/img/counter-icon-1.svg" alt="img">
                ...
                <img class="conference-counter-effect-2"
            ...
            <div class="row">
                <div class="col-lg-6 our-mission-img">
                    <span>
                        ...
                        <img class="mission-img rx-lazy"
                            src="{{ asset('Ginger') }}/assets/img/placeholder-all.png"
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="buy-ticket-form">
                    <form id='contactform' action="{{ asset('Ginger') }}/assets/php/contact.php"
                        name="contactform">
                        <h5>Information</h5>
                        <ul class="form-cover">
                            <li class="inp-cover inp-name"><input id="name" type="text" name="your-name"
                                    placeholder="Name"></li>
                            <li class="inp-cover inp-email"><input id="email" type="email"
                                    name="your-email" placeholder="E-mail"></li>
...
<section id="news" class="s-conference-news"
    style="background-image: url({{ asset('Ginger') }}/assets/img/bg-news.jpg);">
    <div class="conference-news-container">
        ...
        <div class="conference-news-slider">
            <div class="conference-news-slide">
                <div class="conference-news-item">
                    <div class="conference-post-thumbnail">
                        <a href="single-blog.html"><img src="{{ asset('Ginger') }}/assets/img/post-1-home2.jpg"
                                alt="img"></a>
                    </div>
                    ...
                    <div class="conference-post-content">
                        ...
                        <div class="conference-post-meta"><i class="fas fa-user" aria-hidden="true"></i>By <a
                                href="blog.html">Samson peters</a>
                        </div>
            ...
            <div class="conference-news-slide">
                <div class="conference-news-item">
                    <div class="conference-post-thumbnail">
                        <a href="single-blog.html"><img src="{{ asset('Ginger') }}/assets/img/post-2-home2.jpg"
                                alt="img"></a>
                    </div>
            ...
            <div class="conference-news-slide">
                <div class="conference-news-item">
                    <div class="conference-post-thumbnail">
                        <a href="single-blog.html"><img src="{{ asset('Ginger') }}/assets/img/post-3-home2.jpg"
                                alt="img"></a>
                    </div>
            ...
            <div class="conference-news-slide">
                <div class="conference-news-item">
                    <div class="conference-post-thumbnail">
                        <a href="single-blog.html"><img src="{{ asset('Ginger') }}/assets/img/post-4-home2.jpg"
                                alt="img"></a>
                    </div>
